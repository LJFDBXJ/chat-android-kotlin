...
enum class InviteMessageStatus(@param:StringRes val msgContent: Int) {
    ...
    BEAGREED(R.string.demo_contact_listener_onFriendRequestAccepted),  //==group application
    ...
    REFUSED(R.string.Has_refused_to),  //==group invitation
    ...
    GROUPINVITATION_DECLINED(R.string.demo_system_other_decline_received_remote_user_invitation),  //==multi-device
